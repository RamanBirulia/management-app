...
const entry = (id: string, projects: LogEntry["projects"]): LogEntry => ({ id, type: "decision", content: id, description: "", occurredAt: "2026-08-24T08:00:00Z", status: null, assigneeId: null, dueDate: null, createdAt: "", updatedAt: "", people: [], projects, sources: [] });
