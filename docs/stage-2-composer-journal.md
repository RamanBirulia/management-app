...
- Description раскрывается компактным шевроном после заголовка; type, дата, assignee, due и status собраны в одну нейтральную строку метаданных с единым форматом дат.
